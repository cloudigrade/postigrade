...
export COMPONENT_NAME="postigrade"  # name of app-sre "resourceTemplate" in deploy.yaml for this component
export IMAGE="quay.io/cloudservices/postigrade"  # the image location on quay
...
bonfire deploy \
    ...
    --set-parameter postigrade/IMAGE=${IMAGE} \
    --set-parameter postigrade/IMAGE_TAG=${GIT_COMMIT} \
